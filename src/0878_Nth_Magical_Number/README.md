...
- Link: [https://leetcode.com/problems/nth-magical-number/](https://leetcode.com/problems/nth-magical-number/)

## Idea
First find the least common multiple `lcm` of two numbers `a` and `b`.
For each interval $((m-1) \cdot \textbf{lcm}, m \cdot \textbf{lcm} ]$ numbers, there are `lcm / a + lcm / b - 1` magical numbers
