...
## Idea
Use two pointers to find the `k` and `N - k + 1` position.
- Time complexity: `O(n)`
...
2. After transforming the linked list to an array it becomes as easy as swapping two integers in an array then rebuilding the linked list
