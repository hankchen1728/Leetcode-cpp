...
## Idea
Create a hash table storing the frequency of sum of paired elements of `nums1` and `nums2`.
Then check if sum of paired elements of `nums3` and `nums4` can match the items in above hash table.
