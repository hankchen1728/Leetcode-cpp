# 120. Triangle
- Link: [https://leetcode.com/problems/triangle/submissions/](https://leetcode.com/problems/triangle/submissions/)

## Idea
Use the relationship `dp[h][j] = min(dp[h+1][j], dp[h+1][j+1])` and run from bottom to top, finally return the `dp[0][0]`.
