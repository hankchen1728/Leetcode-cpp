...
<p>&nbsp;</p>
<strong>Follow up:</strong> Squaring each element and sorting the new array is very trivial, ould you find an <code>O(n)</code> solution using a different approach?
