...
- Link: [https://leetcode.com/problems/largest-plus-sign/](https://leetcode.com/problems/largest-plus-sign/)

## Idea
Simply applying dynamic programming to record the longest 1s of up, left, down, right at each position.
