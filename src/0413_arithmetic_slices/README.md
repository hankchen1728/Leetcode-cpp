...
## Idea
Using **dynamic programming** to calulate the length of subarray, whose all consecutive differences are same.
At each step, compare the consecutive difference with last one.
