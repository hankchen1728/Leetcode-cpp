...
- Link: [https://leetcode.com/problems/number-of-unique-good-subsequences/](https://leetcode.com/problems/number-of-unique-good-subsequences/)

## Idea
`dp[0]` refers to number of subsequences ends with `1`, similarly, `dp[1]` refers to number of subsequences ends with `1`.
The answer will be `dp[0] + dp[1] + 1` if `0` is in the original string `binary`.
