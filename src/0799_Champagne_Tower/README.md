# 799. Champagne Tower
- Link: [https://leetcode.com/problems/champagne-tower/](https://leetcode.com/problems/champagne-tower/)

## Idea
$v_{(i+1)(j)} = v_{(i+1)(j)} + \dfrac{v_{(i)(j)} - 1}{2}$

$v_{(i+1)(j+1)} = v_{(i+1)(j+1)} + \dfrac{v_{(i)(j)} - 1}{2}$
